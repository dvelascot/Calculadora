...
//resta
    ...
    private void paint(){
        ...
        if(auxiliarParentesis!=0){
            jButton11.setEnabled(false);
        }
        else{
            jButton11.setEnabled(true);
        }
        String numero = calc.getLastNumber();
        if(numero.equals("")) jButton17.setEnabled(false);
        else{
            for(int i=0;(i<numero.length())&&!hayPunto;i++){
                if(numero.charAt(i)=='.') hayPunto=true;
            }
            if(hayPunto){
                jButton17.setEnabled(false);
            }
